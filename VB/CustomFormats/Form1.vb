...
Namespace CustomFormats
	Partial Public Class Form1
		...
		Public Sub CreateAppointmentFormatStringService()
			Me.prevAppointmentFormatStringService = CType(schedulerControl1.GetService(GetType(IAppointmentFormatStringService)), IAppointmentFormatStringService)
		...
		Public Sub CreateTimeRulerFormatStringService()
			Me.prevTimeRulerFormatStringService = CType(schedulerControl1.GetService(GetType(ITimeRulerFormatStringService)), ITimeRulerFormatStringService)
		...
		Public Sub CreateHeaderCaptionService()
			Me.prevHeaderCaptionService = CType(schedulerControl1.GetService(GetType(IHeaderCaptionService)), IHeaderCaptionService)
		...
		Public Sub CreateHeaderToolTipService()
			Me.prevHeaderToolTipService = CType(schedulerControl1.GetService(GetType(IHeaderToolTipService)), IHeaderToolTipService)
